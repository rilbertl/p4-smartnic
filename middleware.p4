...
control MyIngress(inout headers hdr,
	...
	action encaminhaDecapture_inner (egressSpec_t egressPort, port_t dataPort, ip4Addr_t ip_dec1, port_t port_dec1, macAddr_t mac_dec1, ip4Addr_t ip_dec2, port_t port_dec2, macAddr_t mac_dec2) {

                standard_metadata.egress_spec = egressPort;
                hdr.ipv4_inner.ttl = hdr.ipv4_inner.ttl - 1;
		hdr.udp_inner.srcPort = dataPort;
		...
		if (ip_dec1 != 0 && port_dec1 != 0 && mac_dec1 != 0) {
			...
			hdr.ipv4_inner.dstAddr = ip_dec1;
			hdr.udp_inner.dstPort = port_dec1;
		}
	...
	action encaminhaDecapture (egressSpec_t egressPort, ip4Addr_t ip_dec1, port_t port_dec1, macAddr_t mac_dec1, ip4Addr_t ip_dec2, port_t port_dec2, macAddr_t mac_dec2) {
